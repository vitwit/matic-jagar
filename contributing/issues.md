...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Matic-Jagar, creating a new issue in the `vitwit/matic-jagar`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `vitwit/matic-jagar` in a concrete and reviewable manner.

## Asking for General Help

The best place to ask for help is through the discussion through the mail or any other available pplatforms.

## Submitting a Bug Report

When opening a new issue in the `vitwit/matic-jagar` issue tracker, please provide as much
detail about your environment and matic-jagar configuration as possible.
...
functional guidelines of the Matic-Jagar.