...
More details to come on Matic-Jagar dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/vitwit/matic-jagar/issues/) or engage trough email with our support team (support@vitwit.com).
...
Fork the project [on GitHub](https://github.com/vitwit/matic-jagar.git) and clone your fork
locally.

```text
$ git clone https://github.com/vitwit/matic-jagar.git
$ cd matic-jagar
$ git remote add upstream https://github.com/vitwit/matic-jagar.git
$ git fetch upstream
```
...
Make the changes to your code by following go standards and by fixing lint issues.
...
3. The body copy must be wrapped at 72 columns.

4. The body copy must only contain explanations as to what and why, never how. The latter belongs in documentation and implementation. If your patch fixes an open issue, you can add a reference to it at the end of the log. Use the `Fixes:` prefix and the full issue URL. For other references use `Refs:`.
...
Fixes: https://github.com/vitwit/matic-jagar/issues/4
Refs: https://gist.github.com/turbo/efb8d57c145e00dc38907f9526b60f17
```

If you are new to contributing to Matic-Jagar, please try to do your best at
...
Once you are sure your commits are ready to go, with testing and linting,
...
at least two Matic-Jagar Collaborators (one Collaborator approval is enough if the
...
All Matic-Jagar contributors who choose to review and provide feedback on Pull
...
reviewers are strictly counter to the [Code of Conduct](https://github.com/vitwit/matic-jagar/blob/add-license/CONTRIBUTING.md#code-of-conduct).
...
1. Does this change make sense for Matic-Jagar?
2. Does this change make Matic-Jagar better, even if only incrementally?
...
Matic-Jagar Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Matic-Jagar better, but the individual might just
not want to have anything to do with Matic-Jagar ever again. The goal is not just
having good code.
...
Any Matic-Jagar core Collaborator (any GitHub user with commit rights in the
`vitwit/matic-jagar` repository) is authorized to approve any other contributor's
...
Matic-Jagar has always optimized for speed of execution. If a particular change
can be shown to make some part of Matic-Jagar faster, it's quite likely to be
...
That said, performance is not the only factor to consider. Matic-Jagar also
...
### Test your changes well before committing to the repo

Every Pull Request needs to be tested
to make sure that it works on the platforms that Matic-Jagar
...
submitted, even after it gets approved and passes the test cases. This is to make sure
...
[Code of Conduct]: https://github.com/vitwit/matic-jagar/blob/add-license/CONTRIBUTING.md#code-of-conduct
[Collaborator Guide]: https://github.com/vitwit/matic-jagar/blob/add-license/CONTRIBUTING.md